...
%check_yes_or_no('./ProjectSounds/Others/n2.wav',longest_signal)


%check_yes_or_no('./ProjectSounds/GoodNo/n7.wav',longest_signal)

check_yes_or_no('./ProjectSounds/GoodYes/y20.wav',longest_signal)
